...
if __name__ == '__main__':
    # toy(Path('../dataset/partnet-mobility/179'), Path('output/d'), Path('output/m'))
    # exit(0)
    import os
    import time
    import shutil

    raw_dataset_paths = glob("../dataset/partnet-mobility/*")

    output_info_path = Path('output/1_preprocessed_info')
