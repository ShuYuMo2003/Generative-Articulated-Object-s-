...
from utils.generator_utils import libmcubes
from utils.generator_utils.common import make_3d_grid
from utils.generator_utils.libsimplify import simplify_mesh
from utils.generator_utils.libmise import MISE
...
class Generator3DSDF(object):
    ...
    def eval_points(self, p, z, c=None, **kwargs):
        ...
        for pi in p_split:
            ...
            with torch.no_grad():
                occ_hat = self.model.forward_with_plane_features(z, pi * 2)
    ...
    def refine_mesh(self, mesh, occ_hat, z, c=None):
        ...
        # [SJY]: @see https://github.com/pytorch/pytorch/issues/34704
        ...
        for it_r in trange(self.refinement_step):
            ...
            face_value = self.model.forward_with_plane_features(z, face_point.unsqueeze(0) * 2).unsqueeze(-1)
